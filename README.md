...
This is a fork of that extension that supports other website than youtube and not only videos, [see below](https://github.com/ch-dewez/mikan/blob/main/README.md#supported-websites).
